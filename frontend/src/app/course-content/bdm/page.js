...
const CourseContentPage = ({ courseName }) => {
    ...
    weeks: [
      {
        ...
        progress: 100,
        modules: [
          { title: "Introduction to Course", duration: "15:00", completed: true, videoUrl: "https://www.youtube.com/embed/3JZ_D3ELwOQ" },
          { title: "Basic Concepts", duration: "20:00", completed: true, videoUrl: "https://www.youtube.com/embed/tgbNymZ7vqY" },
        ],
      },
      {
        title: "Week 2",
        progress: 0,
        modules: [
          { title: "Advanced Topics", duration: "25:00", completed: false, videoUrl: "https://www.youtube.com/embed/tgbNymZ7vqY" },
        ],
      },
    ],
  };
  ...
  return (
    <div className="bg-white min-h-screen p-6"> {/* White background applied here */}
