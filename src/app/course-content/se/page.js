  ...
  return (
    <div className="flex flex-col lg:flex-row p-6 mt-16"> {/* Increased top margin */}
      ...
      <div className="w-full lg:w-1/3 bg-white p-6 shadow-lg rounded-lg">
        <h1 className="text-2xl font-bold mb-4">Software Engineering</h1>
...
export default function Page() {
  return <CourseContentPage courseName="Software Engineering" />; // Change to "Business Data Management" for BDM
}
