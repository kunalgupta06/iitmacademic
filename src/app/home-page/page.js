...
export default function Home() {
    return (
      <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100">
        <h1 className="text-3xl text-black font-bold mb-8">Welcome to AskIVA</h1>
        <div className="space-x-4">
          ...
          <a href="/about-us" className="px-6 py-3 bg-red-400 text-white rounded-lg hover:bg-red-500">Our Misson & Team</a>
        </div>
      </div>
    );
  }